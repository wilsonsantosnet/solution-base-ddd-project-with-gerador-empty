...
namespace Seed.Domain.Services
{
    public class SampleServiceBase : ServiceBase<Sample>
    {
        ...
        protected readonly IValidatorSpecification<Sample> _validation;
        protected readonly IWarningSpecification<Sample> _warning;
        ...
        {
            this._validationResult  = this._validationResult.Merge(this._validation.Validate(sample));
			this._validationWarning  = this._validationWarning.Merge(this._warning.Validate(sample));
        }
